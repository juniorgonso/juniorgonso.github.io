function grid(t, e) {
  ...
  s.setAttribute("x1", 15),
    s.setAttribute("y1", 0),
    s.setAttribute("x2", 15),
...
function cross([t, e, n, s, r, i, o, c]) {
...
function text(t, e) {
  ...
  s.appendChild(r), e && s.setAttribute("class", "reserved");
  const i = [[15, 24]];
  return (
    s.setAttribute(
      "transform",
      i.map(([t, e]) => `translate(${t}, ${e})`).join(" "),
    ),
    n.appendChild(s),
    n
  );
...
function render(t) {
  ...
  for (let n = 0; n < t.length; n++)
    for (let s = 0; s < t[n].length; s++) {
      ...
      let c = !1;
      for (let e = 0; e < s; e++) '"' == t[n][e] && (c = !c);
      const p = around(t, [s, n]);
      if (r.match(/[A-Za-z0-9]/)) {
        const [, t, , e] = p;
        c = c || e.match(/[A-Za-uw-z0-9]/) || t.match(/[A-Za-uw-z0-9]/);
      }
      (i = i && !c),
        i && o.appendChild(glyphs[r](p)),
        o.appendChild(text(r, i)),
        o.setAttribute("transform", `translate(${30 * s} ${54 * n})`),
        e.appendChild(o);
    }
  return e;
}
function create(t, e, n) {
  ...
  for (let t = 0; t < s.length; t++)
    for (let e = 0; e < s[t].length; e++) s[t].length > r && (r = s[e].length);
  var o = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  o.setAttribute("width", 30 * r * e),
    o.setAttribute("height", 54 * i * e),
    o.setAttribute("debug", n);
  const c = 0;
  return (
    o.setAttribute(
      "viewBox",
      `${-c} ${-c} ${30 * r + 2 * c} ${54 * i + 2 * c}`,
    ),
    o.setAttribute("class", "debug"),
    o.appendChild(render(s)),
    n && o.appendChild(grid(r, i)),
    o
  );
}
function around(t, [e, n]) {
  let s = " ",
    r = " ",
    i = " ",
    o = " ",
  ...
  return (
    ...
    e > 0 && (s = t[n][e - 1] || " "),
    n > 0 && e < t[n - 1].length - 1 && (c = t[n - 1][e + 1] || " "),
    n + 1 < t.length && e < t[n + 1].length && (p = t[n + 1][e + 1] || " "),
    n < t.length - 1 && e > 0 && (l = t[n + 1][e - 1] || " "),
    n > 0 && e > 0 && (u = t[n - 1][e - 1] || " "),
    [r, i, o, s, c, p, l, u]
  );
}
const ratio = 2,
  glyphs = {
    ...
    "-": ([t, e, n, s, r, i, o, c]) =>
      cross([["|"].includes(t), !0, ["|"].includes(n), !0, !1, !1, !1, !1]),
    "~": ([t, e, n, s, r, i, o, c]) => {
      const p = document.createElementNS("http://www.w3.org/2000/svg", "g"),
        l = document.createElementNS("http://www.w3.org/2000/svg", "line");
      return (
        l.setAttribute("x1", "9"),
        l.setAttribute("y1", "27"),
        l.setAttribute("x2", "24"),
        l.setAttribute("y2", "27"),
        l.setAttribute("class", "part"),
        p.appendChild(l),
        p
      );
    },
    ...
    ":": ([t, e, n, s, r, i, o, c]) => {
      ...
      if (
        ...
        l.setAttribute("y2", "60"),
        l.setAttribute("class", "part"),
        l.setAttribute("style", "stroke-dasharray: 15; stroke-dashoffset: 0;"),
        p.appendChild(l),
        "+" == t)
      ) {
        const t = document.createElementNS(
    ...
    "*": ([t, e, n, s, r, i, o, c]) => {
      ...
      return (
        ...
        l.setAttribute("transform", "translate(15, 27)"),
        p.appendChild(l),
        p.appendChild(
          cross([
            ["+", "|"].includes(t),
    ...
    o: ([t, e, n, s, r, i, o, c]) => {
      ...
      l.setAttribute("cx", "0"),
        ...
        l.setAttribute("stroke", "var(--global-text-color)"),
        l.setAttribute("transform", "translate(15, 27)"),
        p.appendChild(l);
      const u = cross([
        ["+", "|"].includes(t),
      ...
      return (
        ...
        a.setAttribute("opacity", "100%"),
        a.setAttribute("transform", "translate(15, 27)"),
        p.appendChild(a),
        p
      );
    },
    "/": (t) => {
      const [e, n, s, r, i, o, c, p] = t,
        l = document.createElementNS("http://www.w3.org/2000/svg", "g");
      if (
        (l.appendChild(
          cross([["|"].includes(e), !1, ["|"].includes(s), !1, !0, !1, !0, !1]),
        ),
        "\\" == n)
      ) {
        const t = cross([!1, !1, !1, !1, !1, !1, !0, !1]);
        t.setAttribute("transform", "translate(30 -54)"),
          t.setAttribute("clip-path", "polygon(-3 0, 0 0, 0 54, -3 54)"),
          l.appendChild(t);
      }
      if ("\\" == r) {
        const t = cross([!1, !1, !1, !1, !0, !1, !1, !1]);
        t.setAttribute("transform", "translate(-30 54)"),
    ...
    "\\": (t) => {
      ...
      if (
        (l.appendChild(
          cross([["|"].includes(e), !1, ["|"].includes(s), !1, !1, !0, !1, !0]),
        ),
        "/" == r)
      ) {
        const t = cross([!1, !1, !1, !1, !1, !0, !1, !1]);
        t.setAttribute("transform", "translate(-30 -54)"),
          t.setAttribute("clip-path", "polygon(15 0, 30 0, 30 54, 15 54)"),
          l.appendChild(t);
      }
      if ("/" == n) {
        const t = cross([!1, !1, !1, !1, !1, !1, !1, !0]);
        t.setAttribute("transform", "translate(30 54)"),
    ...
    "#": ([t, e, n, s, r, i, o, c]) => {
      const p = document.createElementNS("http://www.w3.org/2000/svg", "g"),
        l = document.createElementNS("http://www.w3.org/2000/svg", "polygon"),
        u = [
          [0, 0],
          [42, 0],
          [42, 42],
      ...
      return (
        l.setAttribute("points", u.map(([t, e]) => `${t},${e}`).join(" ")),
        l.setAttribute("transform", "translate(-6, 6)"),
        p.appendChild(l),
        p.appendChild(
          cross([
            ["+", "|"].includes(t),
    ...
    "+": ([t, e, n, s, r, i, o, c]) => {
      const p = document.createElementNS("http://www.w3.org/2000/svg", "g"),
        ...
        g = ["/", "*", "#"].includes(o);
      if (
        (p.appendChild(cross([a, l, d, u, w, A, g, h])), (u || l) && (d || a))
      ) {
        const t = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "polygon",
      ...
      if (w || h) {
        const t = cross([!1, !1, !1, !1, !1, h, w, !1]);
        t.setAttribute("clip-path", "polygon(0 -3, 30 -3, 30 0, 0 0)"),
          p.appendChild(t);
      }
      if (A || g) {
        const t = cross([!1, !1, !1, !1, g, !1, !1, A]);
        t.setAttribute("clip-path", "polygon(0 27, 15 27, 15 30, 0 30)"),
          p.appendChild(t);
      }
      if (g || h) {
        const t = cross([!1, !1, !1, !1, g && A, h && w, !1, !1]);
        t.setAttribute("clip-path", "polygon(-3 0, 0 0, 0 54, -3 54)"),
          p.appendChild(t);
      }
      if (A || w) {
        const t = cross([!1, !1, !1, !1, !1, !1, w && h, A && g]);
        t.setAttribute("clip-path", "polygon(15 0, 30 0, 30 54, 15 54)"),
          p.appendChild(t);
      }
      if (l || u) {
        const t = cross([!1, !1, !1, !1, l || g, h, w, u || A]);
...
for (const [t, e] of Object.entries(alias)) glyphs[t] = (t) => glyphs[e](t);
(glyphs[">"] = ([t, e, n, s, r, i, o, c]) => {
  const p = document.createElementNS("http://www.w3.org/2000/svg", "g"),
    l = document.createElementNS("http://www.w3.org/2000/svg", "polygon");
  l.setAttribute("points", "0,0 42,18 0,36");
  let u = 0;
  return (
    ("*" != e && "o" != e && "#" != e) || (u -= 18),
    l.setAttribute("transform", `translate(${u} 9)`),
    p.appendChild(l),
    p
  );
}),
  (glyphs["<"] = ([t, e, n, s, r, i, o, c]) => {
    ...
    return (
      ...
      l.setAttribute(
        "transform",
        `translate(${u} 9) translate(0 36) rotate(180)`,
      ),
      p.appendChild(l),
      p
    );
  }),
  (glyphs.v = ([t, e, n, s, r, i, o, c]) => {
    const p = document.createElementNS("http://www.w3.org/2000/svg", "g"),
      l = document.createElementNS("http://www.w3.org/2000/svg", "polygon");
    l.setAttribute("points", "0,0 42,18 0,36");
    let u = 36;
    return (
      " " == n
        ...
        : "_" == n
          ...
          : ("*" != n && "o" != n && "#" != n) || (u -= 18),
      "/" == r
        ? l.setAttribute("transform", "translate(-36 33) rotate(112.5, 42, 18)")
        : "\\" == c
          ? l.setAttribute(
              "transform",
              "translate(-18 33) rotate(67.5, 42, 18)",
            )
          : l.setAttribute("transform", `translate(33 ${u}) rotate(90)`),
      p.appendChild(l),
      p.appendChild(
        cross([
          ["|", "+"].includes(t),
  ...
  (glyphs["^"] = ([t, e, n, s, r, i, o, c]) => {
    ...
    return (
      ...
      "/" == o
        ? l.setAttribute(
            "transform",
            "translate(-18 -15) rotate(-67.5, 42, 18)",
          )
        : "\\" == i
          ? l.setAttribute(
              "transform",
              "translate(-36 -15) rotate(-112.5, 42, 18)",
            )
          : l.setAttribute("transform", `translate(-3 ${u}) rotate(-90)`),
      p.appendChild(l),
      p.appendChild(
        cross([
          !1,
  ...
  document.addEventListener("readystatechange", () => {
    "complete" === document.readyState &&
      document.querySelectorAll("pre>code.language-typograms").forEach((t) => {
        const e = t.textContent,
          n = t.parentElement.parentElement;
        let s = document.createElement("pre");
        s.classList.add("typogram");
        const r = create("\n" + e, 0.3, !1);
        s.appendChild(r), n.appendChild(s), n.removeChild(t.parentElement);
      });
  });
