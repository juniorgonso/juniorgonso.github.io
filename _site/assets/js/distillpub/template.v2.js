!(function (t) {
  ...
  function o(t, n) {
    return "doi" in t
      ? `${n ? "<br>" : ""} <a href="https://doi.org/${t.doi}" style="text-decoration:inherit;">DOI: ${t.doi}</a>`
      : "";
  }
  function a(t) {
  ...
  const Mr = [
    ...
    _r = (t) => (t < 10 ? "0" + t : t),
    Ar = function (t) {
      return `${Mr[t.getDay()].substring(0, 3)}, ${_r(t.getDate())} ${Tr[t.getMonth()].substring(0, 3)} ${t.getFullYear().toString()} ${t.getUTCHours().toString()}:${t.getUTCMinutes().toString()}:${t.getUTCSeconds().toString()} Z`;
    },
    Er = function (t) {
