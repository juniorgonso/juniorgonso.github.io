let toggleThemeSetting = () => {
  ...
  applyTheme = () => {
    ...
    for (let o = 0; o < t.length; o++)
      "dark" == e
        ? t[o].classList.add("table-dark")
        : t[o].classList.remove("table-dark");
    let o = document.getElementsByClassName(
      "jupyter-notebook-iframe-container",
    );
    for (let t = 0; t < o.length; t++) {
      let r =
        o[t].getElementsByTagName("iframe")[0].contentWindow.document.body;
      "dark" == e
        ? (r.setAttribute("data-jp-theme-light", "false"),
          r.setAttribute("data-jp-theme-name", "JupyterLab Dark"))
        : (r.setAttribute("data-jp-theme-light", "true"),
          r.setAttribute("data-jp-theme-name", "JupyterLab Light"));
    }
  ...
  setEchartsTheme = (e) => {
    document.querySelectorAll(".echarts").forEach((t) => {
      let o = t.previousSibling.childNodes[0].innerHTML;
      if ((echarts.dispose(t), "dark" === e))
        var r = echarts.init(t, "dark-fresh-cut");
  ...
  setVegaLiteTheme = (e) => {
    document.querySelectorAll(".vega-lite").forEach((t) => {
      ...
      (t.innerHTML = ""),
        "dark" === e
          ? vegaEmbed(t, JSON.parse(o), { theme: "dark" })
          : vegaEmbed(t, JSON.parse(o));
    });
  },
  setSearchTheme = (e) => {
